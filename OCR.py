...
def scan():
    ...
    def select():
        ...
        img = Image.open(file)
        img = img.resize((400, 300), Image.BICUBIC)  # or Image.LANCZOS for antialiasing
        ...
        btn1 = Button(SCAN, text="PROCESS", padx=8, font=("", 10), bg='aqua', activebackground="aqua",
                    relief=GROOVE, command=process).pack()
    ...
    def process():
        ...
        img = cv2.imwrite('C:/Users/anura/OneDrive/Desktop/OCR/OPTICAL-CHARACTER-RECOGNITION-main/OPTICAL-CHARACTER-RECOGNITION-main/IMAGES/10.jpg',grayImage)
        Text = pytesseract.image_to_string('C:/Users/anura/OneDrive/Desktop/OCR/OPTICAL-CHARACTER-RECOGNITION-main/OPTICAL-CHARACTER-RECOGNITION-main/IMAGES/10.jpg')
...
window = Tk()
window.title('OCR')
window.iconbitmap(r'C:/Users/anura/OneDrive/Desktop/OCR/OPTICAL-CHARACTER-RECOGNITION-main/OPTICAL-CHARACTER-RECOGNITION-main/IMAGES/ocrimg1.png')
window.configure(bg='yellow')
window.geometry('600x600')

Img = ImageTk.PhotoImage(Image.open(r"C:/Users/anura/OneDrive/Desktop/OCR/OPTICAL-CHARACTER-RECOGNITION-main/OPTICAL-CHARACTER-RECOGNITION-main/IMAGES/ocrimg1.png"))
